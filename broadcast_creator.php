...
<p>球队1：  <input type="text" oninput="this.value=this.value.replace(/[^a-zA-Z]/g,'');" name="team1">    阵容1： <input type="text" oninput="this.value=this.value.replace(/[^a-zA-Z0-9- \/.\']/g,'');" name="squad1">    球队2： <input type="text" oninput="this.value=this.value.replace(/[^a-zA-Z]/g,'');" name="team2">    阵容2： <input type="text" oninput="this.value=this.value.replace(/[^a-zA-Z0-9- \/.\']/g,'');" name="squad2"></p>

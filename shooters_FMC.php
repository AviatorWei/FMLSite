<?php
include_once "method/printgoalscorers.php";
$num1=$_GET['num1'];
$pos=$_GET['pos'];
if($num1<0)
$num1=0;
...
//$round=mysqli_fetch_assoc(mysqli_query($conn,"SELECT Round FROM teams WHERE isalive=1"))['Round'];
//echo("<script>location.href='History/top_goalscorers_".$round.".html';</script>");
//未来可以做成只显示进球数最多的一部分球员
//未来可能可以做成实时的
printTopGoalScorersFMC($conn,"FMC射手榜",$num1,$pos);
	mysqli_close($conn);
?>
